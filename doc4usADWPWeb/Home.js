...
function showNotification(titulo, contenido) {
    $("#notificationHeader").text(titulo);
    $("#notificationBody").text(contenido);


    setTimeout(showTooltip(titulo, contenido), 1000);
};
...
function showTooltip(header, content) {
    ...
    $("#notificationHeader").show("slow");
    $("#notificationBody").show("slow");

    setTimeout(hideTooltip, 3000);
};

function hideTooltip() {
    $("#notificationHeader").hide("slow");
    $("#notificationBody").hide("slow");
    $("#carta").hide("slow");
...
(function () {
    ...
    function onGetAllSlicesSucceeded(docxData) {
        ...
        var selId = "86";//document.getElementById("Id");
        var url = 'http://apicoredoc4us.doc4us.com/api/TBR_PlantillaEmpresa/86';
